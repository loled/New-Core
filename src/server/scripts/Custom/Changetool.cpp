...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "mallld",       SEC_MODERATOR,     true, &HandleVipMallCommand,         "", NULL },
            { "changerace",    0,  false, &HandleChangeRaceCommand,             "", NULL },
            { "changefaction",  0,  false, &HandleChangeFactionCommand,             "", NULL },
            { "customize",      0,  false, &HandleCustomizeCommand,         "", NULL },
