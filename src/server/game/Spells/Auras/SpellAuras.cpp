...
void Aura::HandleAuraSpecificMods (AuraApplication const* aurApp, Unit* caster, bool apply, bool onReapply)
{
	...
	if(GetId() == 6229) // Resguardo abisal
	{
		if(caster->HasAura(91713))// Nether ward talent
			if(caster->HasAura(687) || caster->HasAura(28176))
				caster->AddAura(91711,caster);
	}			
    ...
    if (apply)
    {
        ...
        case SPELLFAMILY_PRIEST:
            ...
            if (GetId() == 17)
            {
				...
				//Reparado cuerpo y alma BoT, ahora te da el 60% de velocidad al castear este aura (17).
    ...
    else
    {
        ...
        case SPELLFAMILY_MAGE:
            ...
            case 66:          // Invisibility
                ...
                break;
            /*case 1463: // Absorción de encantador
            {
